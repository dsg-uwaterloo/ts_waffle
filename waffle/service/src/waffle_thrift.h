...
class waffle_thriftIf {
 public:
  ...
  virtual void search(std::vector<std::string> & _return, const std::string& keys) = 0;
};
...
class waffle_thriftIfSingletonFactory : virtual public waffle_thriftIfFactory {
 public:
  waffle_thriftIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<waffle_thriftIf>& iface) : iface_(iface) {}
  virtual ~waffle_thriftIfSingletonFactory() {}

  virtual waffle_thriftIf* getHandler(const ::apache::thrift::TConnectionInfo&) {
    return iface_.get();
  }
  virtual void releaseHandler(waffle_thriftIf* /* handler */) {}

 protected:
  ::apache::thrift::stdcxx::shared_ptr<waffle_thriftIf> iface_;
};
...
class waffle_thrift_get_client_id_args {
 public:
  ...
  waffle_thrift_get_client_id_args(const waffle_thrift_get_client_id_args&);
  waffle_thrift_get_client_id_args& operator=(const waffle_thrift_get_client_id_args&);
  waffle_thrift_get_client_id_args() {
  }

  virtual ~waffle_thrift_get_client_id_args() throw();
...
class waffle_thrift_get_client_id_pargs {
 public:
  ...
  virtual ~waffle_thrift_get_client_id_pargs() throw();
...
class waffle_thrift_get_client_id_result {
 public:
  ...
  waffle_thrift_get_client_id_result(const waffle_thrift_get_client_id_result&);
  waffle_thrift_get_client_id_result& operator=(const waffle_thrift_get_client_id_result&);
  waffle_thrift_get_client_id_result() : success(0) {
  }

  virtual ~waffle_thrift_get_client_id_result() throw();
  int64_t success;
...
class waffle_thrift_get_client_id_presult {
 public:
  ...
  virtual ~waffle_thrift_get_client_id_presult() throw();
  int64_t* success;
...
class waffle_thrift_register_client_id_args {
 public:
  ...
  waffle_thrift_register_client_id_args(const waffle_thrift_register_client_id_args&);
  waffle_thrift_register_client_id_args& operator=(const waffle_thrift_register_client_id_args&);
  waffle_thrift_register_client_id_args() : block_id(0), client_id(0) {
  }

  virtual ~waffle_thrift_register_client_id_args() throw();
  int32_t block_id;
  int64_t client_id;
...
class waffle_thrift_register_client_id_pargs {
 public:
  ...
  virtual ~waffle_thrift_register_client_id_pargs() throw();
...
class waffle_thrift_register_client_id_result {
 public:
  ...
  waffle_thrift_register_client_id_result(const waffle_thrift_register_client_id_result&);
  waffle_thrift_register_client_id_result& operator=(const waffle_thrift_register_client_id_result&);
  waffle_thrift_register_client_id_result() {
  }

  virtual ~waffle_thrift_register_client_id_result() throw();
...
class waffle_thrift_register_client_id_presult {
 public:
  ...
  virtual ~waffle_thrift_register_client_id_presult() throw();
...
class waffle_thrift_async_get_args {
 public:
  ...
  waffle_thrift_async_get_args() : key() {
  }

  virtual ~waffle_thrift_async_get_args() throw();
  sequence_id seq_id;
  std::string key;
...
class waffle_thrift_async_get_pargs {
 public:
  ...
  virtual ~waffle_thrift_async_get_pargs() throw();
...
class waffle_thrift_async_put_args {
 public:
  ...
  waffle_thrift_async_put_args() : key(), value() {
  }

  virtual ~waffle_thrift_async_put_args() throw();
  sequence_id seq_id;
  std::string key;
  std::string value;
...
class waffle_thrift_async_put_pargs {
 public:
  ...
  virtual ~waffle_thrift_async_put_pargs() throw();
  const sequence_id* seq_id;
  const std::string* key;
...
class waffle_thrift_async_get_batch_args {
 public:
  ...
  waffle_thrift_async_get_batch_args() {
  }

  virtual ~waffle_thrift_async_get_batch_args() throw();
  sequence_id seq_id;
...
class waffle_thrift_async_get_batch_pargs {
 public:
  ...
  virtual ~waffle_thrift_async_get_batch_pargs() throw();
  const sequence_id* seq_id;
...
class waffle_thrift_async_put_batch_args {
 public:
  ...
  waffle_thrift_async_put_batch_args() {
  }

  virtual ~waffle_thrift_async_put_batch_args() throw();
  sequence_id seq_id;
  std::vector<std::string>  keys;
...
class waffle_thrift_async_put_batch_pargs {
 public:
  ...
  virtual ~waffle_thrift_async_put_batch_pargs() throw();
  const sequence_id* seq_id;
  const std::vector<std::string> * keys;
...
class waffle_thrift_get_args {
 public:
  ...
  waffle_thrift_get_args() : key() {
  }

  virtual ~waffle_thrift_get_args() throw();
  std::string key;
...
class waffle_thrift_get_pargs {
 public:
  ...
  virtual ~waffle_thrift_get_pargs() throw();
  const std::string* key;
...
class waffle_thrift_get_result {
 public:
  ...
  waffle_thrift_get_result() : success() {
  }

  virtual ~waffle_thrift_get_result() throw();
  std::string success;
...
class waffle_thrift_get_presult {
 public:
  ...
  virtual ~waffle_thrift_get_presult() throw();
  std::string* success;
...
class waffle_thrift_put_args {
 public:
  ...
  waffle_thrift_put_args() : key(), value() {
  }

  virtual ~waffle_thrift_put_args() throw();
  std::string key;
  std::string value;
...
class waffle_thrift_put_pargs {
 public:
  ...
  virtual ~waffle_thrift_put_pargs() throw();
  const std::string* key;
  const std::string* value;
...
class waffle_thrift_put_result {
 public:
  ...
  waffle_thrift_put_result(const waffle_thrift_put_result&);
  waffle_thrift_put_result& operator=(const waffle_thrift_put_result&);
  waffle_thrift_put_result() {
  }

  virtual ~waffle_thrift_put_result() throw();
...
class waffle_thrift_put_presult {
 public:
  ...
  virtual ~waffle_thrift_put_presult() throw();
...
class waffle_thrift_get_batch_args {
 public:
  ...
  waffle_thrift_get_batch_args() {
  }

  virtual ~waffle_thrift_get_batch_args() throw();
  std::vector<std::string>  keys;
...
class waffle_thrift_get_batch_pargs {
 public:
  ...
  virtual ~waffle_thrift_get_batch_pargs() throw();
  const std::vector<std::string> * keys;
...
class waffle_thrift_get_batch_result {
 public:
  ...
  waffle_thrift_get_batch_result() {
  }

  virtual ~waffle_thrift_get_batch_result() throw();
...
class waffle_thrift_get_batch_presult {
 public:
  ...
  virtual ~waffle_thrift_get_batch_presult() throw();
  std::vector<std::string> * success;
...
class waffle_thrift_put_batch_args {
 public:
  ...
  waffle_thrift_put_batch_args() {
  }

  virtual ~waffle_thrift_put_batch_args() throw();
  std::vector<std::string>  keys;
  std::vector<std::string>  values;
...
class waffle_thrift_put_batch_pargs {
 public:
  ...
  virtual ~waffle_thrift_put_batch_pargs() throw();
  const std::vector<std::string> * keys;
  const std::vector<std::string> * values;
...
class waffle_thrift_put_batch_result {
 public:
  ...
  waffle_thrift_put_batch_result(const waffle_thrift_put_batch_result&);
  waffle_thrift_put_batch_result& operator=(const waffle_thrift_put_batch_result&);
  waffle_thrift_put_batch_result() {
  }

  virtual ~waffle_thrift_put_batch_result() throw();
...
class waffle_thrift_put_batch_presult {
 public:
  ...
  virtual ~waffle_thrift_put_batch_presult() throw();

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);

};

typedef struct _waffle_thrift_search_args__isset {
  _waffle_thrift_search_args__isset() : keys(false) {}
  bool keys :1;
} _waffle_thrift_search_args__isset;

class waffle_thrift_search_args {
 public:

  waffle_thrift_search_args(const waffle_thrift_search_args&);
  waffle_thrift_search_args& operator=(const waffle_thrift_search_args&);
  waffle_thrift_search_args() : keys() {
  }

  virtual ~waffle_thrift_search_args() throw();
  std::string keys;

  _waffle_thrift_search_args__isset __isset;

  void __set_keys(const std::string& val);

  bool operator == (const waffle_thrift_search_args & rhs) const
  {
    if (!(keys == rhs.keys))
      return false;
    return true;
  ...
  bool operator < (const waffle_thrift_search_args & ) const;
...
class waffle_thrift_search_pargs {
 public:


  virtual ~waffle_thrift_search_pargs() throw();
...
typedef struct _waffle_thrift_search_result__isset {
  _waffle_thrift_search_result__isset() : success(false) {}
  bool success :1;
} _waffle_thrift_search_result__isset;

class waffle_thrift_search_result {
 public:

  waffle_thrift_search_result(const waffle_thrift_search_result&);
  waffle_thrift_search_result& operator=(const waffle_thrift_search_result&);
  waffle_thrift_search_result() {
  }

  virtual ~waffle_thrift_search_result() throw();
  std::vector<std::string>  success;

  _waffle_thrift_search_result__isset __isset;

  void __set_success(const std::vector<std::string> & val);

  bool operator == (const waffle_thrift_search_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const waffle_thrift_search_result & ) const;
...
typedef struct _waffle_thrift_search_presult__isset {
  _waffle_thrift_search_presult__isset() : success(false) {}
  bool success :1;
} _waffle_thrift_search_presult__isset;

class waffle_thrift_search_presult {
 public:


  virtual ~waffle_thrift_search_presult() throw();
  std::vector<std::string> * success;

  _waffle_thrift_search_presult__isset __isset;
...
class waffle_thriftClient : virtual public waffle_thriftIf {
 public:
  waffle_thriftClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  waffle_thriftClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
 ...
 public:
  ...
  void recv_put_batch();
  void search(std::vector<std::string> & _return, const std::string& keys);
  void send_search(const std::string& keys);
...
class waffle_thriftProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  waffle_thriftProcessor(::apache::thrift::stdcxx::shared_ptr<waffle_thriftIf> iface) :
    iface_(iface) {
    ...
    processMap_["search"] = &waffle_thriftProcessor::process_search;
  }
...
class waffle_thriftProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  waffle_thriftProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< waffle_thriftIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< waffle_thriftIfFactory > handlerFactory_;
};

class waffle_thriftMultiface : virtual public waffle_thriftIf {
 public:
  waffle_thriftMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<waffle_thriftIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~waffle_thriftMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<waffle_thriftIf> > ifaces_;
  waffle_thriftMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<waffle_thriftIf> iface) {
...
class waffle_thriftConcurrentClient : virtual public waffle_thriftIf {
 public:
  waffle_thriftConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  waffle_thriftConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
 ...
 public:
  ...
  void search(std::vector<std::string> & _return, const std::string& keys);
  int32_t send_search(const std::string& keys);
