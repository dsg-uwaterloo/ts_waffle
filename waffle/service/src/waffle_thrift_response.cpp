...
waffle_thrift_response_async_response_args::~waffle_thrift_response_async_response_args() throw() {
}
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readString(this->result[_i70]);
            }
...
waffle_thrift_response_async_response_pargs::~waffle_thrift_response_async_response_pargs() throw() {
}
...
uint32_t waffle_thrift_response_async_response_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("result", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter72 = (*(this->result)).begin(); _iter72 != (*(this->result)).end(); ++_iter72)
    {
...
::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > waffle_thrift_responseProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< waffle_thrift_responseIfFactory > cleanup(handlerFactory_);
  ::apache::thrift::stdcxx::shared_ptr< waffle_thrift_responseIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > processor(new waffle_thrift_responseProcessor(handler));
  return processor;
}
