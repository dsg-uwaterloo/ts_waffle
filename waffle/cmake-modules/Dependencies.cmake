...
# Attempt to find Thrift
find_package(Thrift ${THRIFT_VERSION} QUIET)

set(THRIFT_INCLUDE_DIR "/usr/local/include")
# Set Thrift library paths
set(THRIFT_LIBRARY "/usr/local/lib/libthrift.a")
set(THRIFTNB_LIBRARY "/usr/local/lib/libthriftnb.a")
set(THRIFT_PROTOCOL_LIBRARY "/usr/local/lib/libthriftprotocol.a") # If needed


if(NOT Thrift_FOUND)
    # Manually check for Thrift libraries and headers if find_package fails
    find_path(THRIFT_INCLUDE_DIR thrift/Thrift.h)
    find_library(THRIFT_LIBRARY NAMES thrift)
    find_library(THRIFTNB_LIBRARY NAMES thriftnb)
    if(THRIFT_INCLUDE_DIR AND THRIFT_LIBRARY AND THRIFTNB_LIBRARY)
        set(Thrift_FOUND TRUE)
        message(STATUS "Found Thrift: include at ${THRIFT_INCLUDE_DIR}, libraries at ${THRIFT_LIBRARY}, ${THRIFTNB_LIBRARY}")
    endif()
...
#
#if (THRIFT_BUILD)
#    message(STATUS "NOT Found Thrift: include at ${THRIFT_INCLUDE_DIR}, libraries at ${THRIFT_LIBRARY}, ${THRIFTNB_LIBRARY}")
#
